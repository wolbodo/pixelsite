...
class __TwigTemplate_5a440589c4d3d271e8c8d805d7748658c25c9989beb21033821ca737c68c79f6 extends Twig_Template
{
    ...
    {
        // line 1
        return $this->loadTemplate((((($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array(), "any", false, true), "isXmlHttpRequest", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array(), "any", false, true), "isXmlHttpRequest", array()), false)) : (false))) ? ("@WebProfiler/Profiler/ajax_layout.html.twig") : ("@WebProfiler/Profiler/layout.html.twig")), "@BoltProfiler/toolbar/bolt.html.twig", 1);
    }
...
.sf-minitoolbar img {
    ...
    ";
        ...
        ";
        // line 23
        if ( !twig_test_empty($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "versionname", array()))) {
            // line 24
            echo "            <span class=\"sf-toolbar-status sf-toolbar-status-yellow\">";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "versionname", array()), "html", null, true);
            echo "</span>
        ";
        }
        // line 26
    ...
    ";
        ...
        echo "<br>
            ...
            ";
        // line 35
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "fullversion", array()), "html", null, true);
        echo " - ";
        echo $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "aboutlink", array());
    ...
    ";
        ...
        // line 52
        echo "    ";
        $this->loadTemplate("@WebProfiler/Profiler/toolbar_item.html.twig", "@BoltProfiler/toolbar/bolt.html.twig", 52)->display(array_merge($context, array("link" => (isset($context["profiler_url"]) ? $context["profiler_url"] : null))));
    }
    ...
    {
        return array (  123 => 52,  118 => 49,  110 => 46,  106 => 44,  104 => 43,  99 => 40,  93 => 38,  91 => 37,  84 => 35,  79 => 33,  74 => 30,  72 => 29,  69 => 28,  65 => 26,  59 => 24,  57 => 23,  52 => 21,  47 => 18,  45 => 17,  30 => 4,  27 => 3,  18 => 1,);
    }
}
...
/*         <div class="sf-toolbar-info-piece">*/
/*             <hr style="margin: 0;">*/
/*             Edit: <a href="{{ collector.editlink }}">{{ collector.edittitle|excerpt(40)|default("(no title)") }}</a>*/
/*         </div>*/
/*         {% endif %}*/
/* */
/* */
